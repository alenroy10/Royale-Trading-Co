...
const FORM_ENDPOINT = 'https://formsubmit.co/ajax/royaletradingco.exports@gmail.com';
const inquiryLabels = {
...
contactForm?.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    setFormStatus(
      'Could not send right now. Please email royaletradingco.exports@gmail.com or call +91 75109 95173.',
      'is-error'
    );
